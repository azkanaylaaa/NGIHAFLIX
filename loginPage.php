...
<html lang="en">
  ...
  <a href="./landing.php" type="submit" class="btn btn-danger mt-3" style="width: 100%;">Sign In</a></a>
  ...
  <div class="mt-3 ">
                    ...
                    <p class="m-0  text-white"> <span style="color: rgba(212, 212, 212, 0.75);">New to Ngihaflix?</span>  Sign up now.</p>
